...
void reset_system() {
	...
	alt_write_word(md5_group_control+1, 0b00000000000000000000000000000001); //assert reset

	while(!(alt_read_word(md5_group_control+1) & 0b00000000000000000000000000000001));

	printf("Reset done. Deasserting signal\n");
	while((alt_read_word(md5_group_control+1) & 0b00000000000000000000000000000001)); //deassert
}
